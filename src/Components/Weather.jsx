              ...
              <div className="sm:h-form xs:h-screen sm:w-form xs:w-screen sm:rounded-3xl sm:p-16 xs:py-10 xs:px-5 bg-blue-900 backdrop-blur-sm bg-opacity-50 shadow-md">
                <div className="border flex mb-4">
                  <input
                    ...
                    placeholder="Enter a country"
                  />
                  <button className="h-8 px-4 bg-white text-blue-900 hover:bg-blue-100">
                    Search
                  </button>
                </div>
                ...
                <div className="sm:h-3/5 grid-cols-2 sm:flex">
                  <div className="sm:w-3/5 py-4">
                    <h1 className="sm:text-4xl xs:text-2xl font-bold">Loading...</h1>
                    <h1 className="text-lg">loading...</h1>
                    <h1 className="text-sm">loading...</h1>
                    <br className="sm:block xs:hidden" />
                    <h1 className="text-7xl sm:block xs:hidden">... °C</h1>
                  </div>

                  {/* Weather Icon and Description */}
                  <div className="sm:w-2/5 flex flex-col items-center">
                    <img className="h-48 w-48 -mt-2" alt="weather-icons" />
                    <h1 className="text-3xl -mt-2 font-bold">...</h1>
                    <h1 className="text-2xl sm:hidden xs:block">... °C</h1>
                  </div>
                </div>
